...
class WasteSegSampler(Sampler):
    """Sampler for WasteSeg"""

    def __init__(self, dataset: WasteSegDataset):
...
class WasteSegCustomBatch:
    """Custom batch definition with memory pinning for WasteSeg"""
...
def WasteSegCollate(batch_data):
    return WasteSegCustomBatch(batch_data)
